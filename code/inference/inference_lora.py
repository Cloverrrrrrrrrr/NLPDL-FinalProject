...
def load_lora_model(lora_path, model_path):
...
def main(folder_path, output_file, lora_path, model_path):
    # 加载数据
    problems = load_data_from_jsonl(folder_path)

    # 加载模型
    model, tokenizer = load_lora_model(lora_path, model_path)
...
if __name__ == "__main__":
    ...
    main(test_path, output_file, lora_path, model_path)
