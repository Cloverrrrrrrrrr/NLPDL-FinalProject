...
def main(folder_path, output_file, index_path, documents_path, finetune):
    # 加载数据
    ...
    model_path = "/ceph/home/yangshu/lema/llama3-8B"
...
if __name__ == '__main__':
    folder_path = "/ceph/home/yangshu/lema/final_project/test_data/math_test.jsonl"
    output_file = "/ceph/home/yangshu/lema/final_project/project/ragno.jsonl"
    ...
    main(folder_path, output_file, index_path, documents_path, finetune)
